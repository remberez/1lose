    ...
    <div className="w-full mx-auto border rounded-md shadow p-2 bg-white font-inter">
      ...
      {isOpen && (
        <div className="flex justify-between gap-x-2 mt-2">
          <button className="flex text-sm justify-between items-center p-1 bg-gray-200 rounded-md flex-1 hover:bg-gray-300" onClick={() => onEventClick(eventData.first_outcome, eventData)}>
          ...
          <button className="flex text-sm justify-between items-center p-1 bg-gray-200 rounded-md flex-1 hover:bg-gray-300" onClick={() => onEventClick(eventData.second_outcome, eventData)}>
